...
@Name("tempMailboxRemovalScheduler")
@Scope(ScopeType.APPLICATION)
public class TempMailboxRemovalScheduler {
	@Logger(value="scheduler") Log log;
	private static int DURATION_BOX=-20;
	public static TempMailboxRemovalScheduler instance(){
		return (TempMailboxRemovalScheduler) Component.getInstance(TempMailboxRemovalScheduler.class);
	}
	@Asynchronous
